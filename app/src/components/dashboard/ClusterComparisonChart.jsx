...
export default function ClusterComparisonChart({ series }) {
  if (!series?.length) {
  ...
  return (
    <ResponsiveContainer height={220} width="100%">
      <LineChart data={series} margin={{ top: 8, right: 12, bottom: 0, left: 0 }}>
        ...
        <Line dataKey="own" name="Eigene Anzeige" stroke="var(--pw-navy-800)" strokeWidth={2} dot={false} activeDot={{ r: 4 }} />
